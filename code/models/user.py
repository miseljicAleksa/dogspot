...
class UserModel(db.Model):
    ...
    def send_confirmation_email(self) -> Response:
        ...
        text = "Please click the link to cinfirm your registration: {link}".format(link=link)
        html = "<html>Please click the link to confirm your registration: <a href={link}>link</a></html>".format(link=link)
